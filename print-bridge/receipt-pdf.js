/**
 * B's Deli — PDF Receipt Generator
...
function generateReceiptPDF(order, store) {
    return new Promise((resolve, reject) => {
        try {
            ...
            // Create PDF with receipt-width page
            const doc = new PDFDocument({
                size: [RECEIPT_WIDTH, 800], // tall page, we'll trim later
            ...
            // ---- Store Header ----
            drawLine();
            centerText(store.name || "B's Deli", 16, 'Helvetica-Bold');
